...
import com.dep.sula.dao.custom.impl.CustomerDAOImpl;
import com.dep.sula.util.CustomerTM;
   ...
   @FXML
    ...
    void btnSaveOnAction(ActionEvent event) throws SQLException {
        ...
        if(btnSave.getText().equalsIgnoreCase("save")) {
            ...
            int i= customerBO.saveCustomer(new CustomerDTO(id,nm,add));
            if(i<=0){
                connection.rollback();
            ...
            int i=customerBO.updateCustomer(customerDTO);
            if ((i < 0)) {
                connection.rollback();
    ...
    public void loadCustomer() throws SQLException {
        ArrayList<CustomerDTO> customers= customerBO.findAllCustomers();
    ...
    private void deleteCustomer(String id) throws SQLException {
        ...
        if (buttonType.get()==ButtonType.YES){
            try {
                int i= customerBO.deleteCustomer(id);
                if(i>0){
                    connection.commit();
